...
export const PRODUCTS = [
  ...
  {
    id: 5,
    productName: "RAKK LAM ANG PRO (BAREBONE)",
    price: 49.99,
  ...
  {
    id: 6,
    productName: "Gateron Switches (120 pcs)",
    price: 59.99,
